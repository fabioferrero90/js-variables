...
// 6. Trascrivo la lista della spesa (NON SAPEVO CHE FARCI DI QUESTA VARIABILE)
const unorderedList = shoppingList.replaceAll(', ', '\n- ');
const listaDellaSpesa = `Devo ricordarmi di comprare: \n- ${unorderedList}`;
